...
# settings
output_dir = '/Users/mncavieres/Documents/2026-1/Sombrero_REVEAL/Data/jam_models_nested_beta_bh'
...
sampler = DynamicNestedSampler(log_likelihood, prior_transform, ndim=7,
                               nlive=100,
