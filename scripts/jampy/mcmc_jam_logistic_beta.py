...
# settings
output_dir = '/Users/mncavieres/Documents/2026-1/Sombrero_REVEAL/Data/jam_models/no_gamma'
...
def log_likelihood(params):
    bh_mass, r_a, alpha, beta_0, beta_inf = params
    # bh mass in Msun
...
def prior_transform(utheta):
    ...
    # bh_mass, r_a, alpha, beta_0, beta_inf 
    ...
    alpha = alpha_min + utheta[2] * (alpha_max - alpha_min)
    beta_0 = beta_0_min + utheta[3] * (beta_0_max - beta_0_min)
    beta_inf = beta_inf_min + utheta[4] * (beta_inf_max - beta_inf_min)

    return np.array([bh_mass, r_a, alpha, beta_0, beta_inf])

sampler = DynamicNestedSampler(log_likelihood, prior_transform, ndim=5,
                               nlive=100,
