...
def fit_mge_from_f200(
    ...
    *,
    ...
    ngauss=900,                      # max allowed Gaussians (linear=True wants many)
    qbounds=None, #(0.05, 1.0),
    outer_slope=4,
    plot=True,
    quiet=False,
):
...
import pickle
with open('/Users/mncavieres/Documents/2026-1/Sombrero_REVEAL/Data/mge_fit_disk_bulge.pkl', 'wb') as f:
    pickle.dump(res, f)